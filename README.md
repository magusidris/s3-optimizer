...
Optim is a super-simple [Lambda][l] function that can listen to an S3 bucket for uploads, and runs everything it can through [imagekit](https://imagekit.io, "Streamline how you work
